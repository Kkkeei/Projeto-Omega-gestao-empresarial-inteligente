...
<Route path="/documentacao/empresa/:id" element={<EmpresaDocumentacaoPage/>}/><Route path="/pendencias" element={<PendenciasPage/>}/><Route path="/usuarios" element={<AdminOnly><UsuariosPage/></AdminOnly>}/></Route></Routes></BrowserRouter></AuthProvider>}
